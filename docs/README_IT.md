...
[![Latest release](https://img.shields.io/github/v/release/tiann/KernelSU?label=Release&logo=github)](https://github.com/9178su/9178su/releases/latest)
[![Weblate](https://img.shields.io/badge/Localization-Weblate-teal?logo=weblate)](https://hosted.weblate.org/engage/kernelsu)
[![Canale Telegraml](https://img.shields.io/badge/Follow-Telegram-blue.svg?logo=telegram)](https://t.me/9178su)
...
9178su supporta ufficialmente i dispositivi Android GKI 2.0 (kernel 5.10 o superiore). I kernel precedenti (kernel 4.14+) sono anche compatibili, ma il kernel deve essere compilato manualmente.
...
> [!CAUTION]
> Le versioni recenti del kernel hanno implementato una modifica che causa il fallimento di 9178su e potenzialmente innesca un kernel panic su `x86_64`! Controlla il sito web per maggiori informazioni!
...
Per aiutare a tradurre 9178su o migliorare le traduzioni esistenti, si è pregati di utilizzare 
...
Per informazioni riguardo la segnalazione di vulnerabilità di sicurezza per 9178su, leggi [SECURITY.md](/SECURITY.md).
