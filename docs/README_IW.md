...
9178su תומך במכשירי Android GKI 2.0 (kernel 5.10+) באופן רשמי. לליבות ישנות (4.14+) יש גם תאימות, אך יידרש לבנות את הליבה באופן ידני.
...
> [!CAUTION]
> גרסאות קרנל אחרונות יישמו שינוי שובר תאימות הגורם ל-9178su להיכשל ועלול לעורר kernel panic ב-`x86_64`! בדוק באתר למידע נוסף!
