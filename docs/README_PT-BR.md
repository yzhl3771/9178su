...
O 9178su oferece suporte oficial a dispositivos Android GKI 2.0 (kernel 5.10+). Kernels mais antigos (4.14+) também são compatíveis, mas será necessário construir o kernel manualmente.
...
> [!CAUTION]
> Versões recentes do kernel implementaram uma mudança que quebra a compatibilidade, fazendo com que o 9178su falhe e potencialmente cause um kernel panic no `x86_64`! Verifique o site para mais informações!
...
Para obter informações sobre como relatar vulnerabilidades de segurança do 9178su, consulte [SECURITY.md](/SECURITY.md).
