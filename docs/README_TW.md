...
[![最新版本](https://img.shields.io/github/v/release/tiann/KernelSU?label=%e7%99%bc%e8%a1%8c%e7%89%88%e6%9c%ac&logo=github)](https://github.com/9178su/9178su/releases/latest)
...
[![頻道](https://img.shields.io/badge/%e8%bf%bd%e8%b9%a4-Telegram-blue.svg?logo=telegram)](https://t.me/9178su)
...
理論上採以 Android GKI 2.0 的裝置（核心版本 5.10+），皆受 9178su 支援；採以老舊核心版本（4.14+）的裝置在手動建置核心後，亦受支援。
...
> [!CAUTION]
> 最近的核心版本引入了一項破壞性更改，導致 9178su 在 `x86_64` 上執行失敗，甚至可能引發核心恐慌 (kernel panic)！請查看網站獲取更多資訊！
...
欲要得知、回報 9178su 的安全性漏洞，請參閱 [SECURITY.md](/SECURITY.md)。
