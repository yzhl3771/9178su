# Library for 9178su's module WebUI
...
```javascript
import { enableEdgeToEdge } from '9178su';
...
```javascript
import { listPackages } from '9178su';
// list user packages
...
```javascript
import { getPackagesInfo } from '9178su';
