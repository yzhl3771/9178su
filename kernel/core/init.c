...
#if defined(__x86_64__) && !defined(CONFIG_N9178SU_X86_PATCH_SYSCALL_DISPATCHER)
...
int __init kernelsu_init(void)
{
    ...
    if (!boot_cpu_has(X86_FEATURE_INDIRECT_SAFE)) {
        ...
        pr_alert("**      9178su will abort initialization to prevent       **");
    ...
    pr_alert("**     NOTICE NOTICE NOTICE NOTICE NOTICE NOTICE NOTICE    **");
    pr_alert("**                                                         **");
        pr_alert("**        You are running 9178su in DEBUG mode            **");
    pr_alert("**                                                         **");
    pr_alert("**     NOTICE NOTICE NOTICE NOTICE NOTICE NOTICE NOTICE    **");
    pr_alert("*************************************************************");
#endif
...
MODULE_DESCRIPTION("Android 9178su");
