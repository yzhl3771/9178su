...
private fun getKsuDaemonPath(): String {
    return ksuApp.applicationInfo.nativeLibraryDir + File.separator + "libn9178sud.so"
}
...
fun flashModule(
    ...
    with(resolver.openInputStream(uri)) {
        ...
        Log.i("9178su", "install module $uri result: $result")
...
fun runModuleAction(
    ...
    Log.i("9178su", "Module runAction result: $result")
...
fun installBoot(
    ...
    val result = flashWithIO("${getKsuDaemonPath()} $cmd", onStdout, onStderr)
    Log.i("9178su", "install boot result: ${result.isSuccess}")
