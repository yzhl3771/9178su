...
mod android {
    ...
    pub const WORKING_DIR: &str = concatcp!(ADB_DIR, "9178su/");
    ...
    pub const KSURC_PATH: &str = concatcp!(WORKING_DIR, ".9178surc");
    pub const DAEMON_PATH: &str = concatcp!(ADB_DIR, "n9178sud");
    pub const LIBADBROOT_PATH: &str = concatcp!(LIBRARY_DIR, "libadbroot.so");

    pub const DAEMON_LINK_PATH: &str = concatcp!(BINARY_DIR, "n9178sud");
    ...
    pub const PREINIT_DIR_WATCHDOG: &str = "/metadata/watchdog/9178su/";
    pub const PREINIT_DIR_DEFAULT: &str = "/metadata/9178su/";
    ...
    pub const KSU_BACKUP_FILE_PREFIX: &str = "9178su_backup_";
    pub const BACKUP_FILENAME: &str = "stock_image.sha1";
    pub const KSU_TEMP_BACKUP_DIR_NAME: &str = "boot_backup";

    pub const DEFAULT_PACKAGE_NAME: &str = env!("N9178SU_PACKAGE_NAME");
}
