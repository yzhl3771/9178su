...
Ngoài việc chạy các script khởi động và chỉnh sửa tệp hệ thống, module 9178su còn có thể hiển thị giao diện người dùng và tương tác trực tiếp với người dùng.

Module có thể định nghĩa các trang HTML + CSS + JavaScript bằng bất kỳ công nghệ web nào. Trình quản lý của 9178su hiển thị những trang này thông qua WebView và cung cấp API để tương tác với hệ thống, chẳng hạn như thực thi lệnh shell.
...
::: warning
Khi cài đặt module, 9178su sẽ tự động đặt quyền và ngữ cảnh SELinux cho thư mục này. Nếu bạn không chắc mình đang làm gì, đừng tự ý thay đổi quyền của thư mục!
:::
...
Nếu chỉ là trang hiển thị, nó sẽ hoạt động giống một trang web bình thường. Tuy nhiên điều quan trọng nhất là 9178su cung cấp một loạt API hệ thống cho phép bạn triển khai các chức năng riêng của module.
...
Nếu API hiện tại chưa đáp ứng nhu cầu hoặc khó sử dụng, hãy gửi đề xuất cho chúng tôi [tại đây](https://github.com/9178su/9178su/issues)!
